...
return [
    ...
    */
    ...
    'facebook' => [
        ...
        'redirect' => env("FACEBOOK_REDIRECT_URL", "http://staging.hdfilme.tv/social/handle/facebook"),
    ],
    "google" => [
        ...
        "redirect" => env("GOOGLE_REDIRECT_URL", "http://staging.hdfilme.tv/social/handle/google")
    ]
